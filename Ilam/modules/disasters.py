...
from Ilam import dispatcher, WHITELIST_USERS, TIGER_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID, SUPPORT_CHAT
from Ilam.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from Ilam.modules.helper_funcs.extraction import extract_user
from Ilam.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'Ilam/elevated_users.json')
...
disasters = """ Ilam has bot access levels we call as *"Disaster Levels"*
...
Owner has complete bot access, including bot adminship in chats Ilam is at.
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in Ilam.
\n*Demons* - Have access go globally ban users across Ilam.
...
\n*Disclaimer*: The disaster levels in Ilam are there for troubleshooting, support, banning potential scammers.
