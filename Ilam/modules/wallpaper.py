...
from Ilam import dispatcher, WALL_API, SUPPORT_CHAT
...
def wall(bot: Bot, update: Update, args):
    ...
    if not query:
        ...
        json_rep = r.get(f"https://wall.alphacoders.com/api2.0/get.php?auth={4f1a9a2374e83bf681e4ab7c6d43fcd5}&method=search&term={term}").json()
