...
from Ilam import ALLOW_EXCL, dispatcher, CustomCommandHandler
from Ilam.modules.disable import DisableAbleCommandHandler
from Ilam.modules.helper_funcs.chat_status import user_admin, bot_can_delete, dev_plus, connection_status
from Ilam.modules.sql import cleaner_sql as sql
 ...
 *Following are Disasters only commands, admins cannot use these:*
 • `/gignoreblue <word>`*:* globally ignorea bluetext cleaning of saved word across Ilam.
