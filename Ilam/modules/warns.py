...
from Ilam import dispatcher, BAN_STICKER, WHITELIST_USERS, TIGER_USERS
from Ilam.modules.disable import DisableAbleCommandHandler
from Ilam.modules.helper_funcs.chat_status import (is_user_admin, bot_admin, user_admin_no_reply, user_admin,
                                                     can_restrict)
from Ilam.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from Ilam.modules.helper_funcs.filters import CustomFilters
from Ilam.modules.helper_funcs.misc import split_message
from Ilam.modules.helper_funcs.string_handling import split_quotes
from Ilam.modules.log_channel import loggable
from Ilam.modules.sql import warns_sql as sql
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # Ilam's sticker
        keyboard = []
