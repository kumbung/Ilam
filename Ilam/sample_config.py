...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1259741177:AAFDSKhgHnSrWfeUDvP3fHuP2S2safcsGQM"
    OWNER_ID = "1117300754"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "Dewihoki"  #Just write it without the @ ex "Sawada"
    SUPPORT_CHAT = "@Dewihoki" # Your telegram support chat username, must have the "@" Example: @MyBotSupportGroupChat
